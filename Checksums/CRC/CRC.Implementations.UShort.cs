...
namespace Xevle.Data.Checksums.CRC
{
	public static partial class CRC
	{
		...
		public class UnreflectedUShort : ICRC<ushort>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 17. Default is 16.</param>
			public UnreflectedUShort(ushort polynomial, ushort init, bool refOut, ushort xorOut, int width = 16) : this(polynomial, GenerateTable(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public ushort Value
			{
				get { return (ushort)((reflectOutput ? BitOrder.Reflect(register) : register >> (16 - width)) ^ xorOutput); }
			}
		...
		public class ReflectedUShort : ICRC<ushort>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 17. Default is 16.</param>
			public ReflectedUShort(ushort polynomial, ushort init, bool refOut, ushort xorOut, int width = 16) : this(polynomial, GenerateTableReflected(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public ushort Value
			{
				get { return (ushort)((reflectOutput ? register : BitOrder.Reflect(register, width)) ^ xorOutput); }
			}
