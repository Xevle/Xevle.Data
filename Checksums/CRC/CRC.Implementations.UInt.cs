...
namespace Xevle.Data.Checksums.CRC
{
	public static partial class CRC
	{
		...
		public class UnreflectedUInt : ICRC<uint>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 33. Default is 32.</param>
			public UnreflectedUInt(uint polynomial, uint init, bool refOut, uint xorOut, int width = 32) : this(polynomial, GenerateTable(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public uint Value
			{
				get { return (reflectOutput ? BitOrder.Reflect(register) : register >> (32 - width)) ^ xorOutput; }
			}
		...
		public class ReflectedUInt : ICRC<uint>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 33. Default is 32.</param>
			public ReflectedUInt(uint polynomial, uint init, bool refOut, uint xorOut, int width = 32) : this(polynomial, GenerateTableReflected(polynomial, width), init, refOut, xorOut, width)
			{
			}
