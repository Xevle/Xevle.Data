...
namespace Xevle.Data.Checksums.CRC
{
	public static partial class CRC
	{
		...
		public class UnreflectedByte : ICRC<byte>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 9. Default is 8.</param>
			public UnreflectedByte(byte polynomial, byte init, bool refOut, byte xorOut, int width = 8) : this(polynomial, GenerateTable(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public byte Value
			{
				get { return (byte)((reflectOutput ? BitOrder.Reflect(register) : register >> (8 - width)) ^ xorOutput); }
			}
		...
		public class ReflectedByte : ICRC<byte>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 9. Default is 8.</param>
			public ReflectedByte(byte polynomial, byte init, bool refOut, byte xorOut, int width = 8) : this(polynomial, GenerateTableReflected(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public byte Value
			{
				get { return (byte)((reflectOutput ? register : BitOrder.Reflect(register, width)) ^ xorOutput); }
			}
