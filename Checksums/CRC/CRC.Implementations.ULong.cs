...
namespace Xevle.Data.Checksums.CRC
{
	public static partial class CRC
	{
		...
		public class UnreflectedULong : ICRC<ulong>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 65. Default is 64.</param>
			public UnreflectedULong(ulong polynomial, ulong init, bool refOut, ulong xorOut, int width = 64) : this(polynomial, GenerateTable(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public ulong Value
			{
				get { return (reflectOutput ? BitOrder.Reflect(register) : register >> (64 - width)) ^ xorOutput; }
			}
		...
		public class ReflectedULong : ICRC<ulong>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 65. Default is 64.</param>
			public ReflectedULong(ulong polynomial, ulong init, bool refOut, ulong xorOut, int width = 64) : this(polynomial, GenerateTableReflected(polynomial, width), init, refOut, xorOut, width)
			{
			}
