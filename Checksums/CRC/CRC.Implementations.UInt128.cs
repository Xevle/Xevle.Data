...
namespace Xevle.Data.Checksums.CRC
{
	public static partial class CRC
	{
		...
		public class UnreflectedUInt128 : ICRC<UInt128>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 129. Default is 128.</param>
			public UnreflectedUInt128(UInt128 polynomial, UInt128 init, bool refOut, UInt128 xorOut, int width = 128) : this(polynomial, GenerateTable(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			{
				get { return (reflectOutput ? BitOrder.Reflect(register) : register >> (128 - width)) ^ xorOutput; }
			}
		...
		public class ReflectedUInt128 : ICRC<UInt128>
		{
			...
			/// <param name="xorOut">Value to be XORed with the reflected or unreflected register depending on <paramref name="refOut"/> before output. Filled in the least significant bits.</param>
			/// <param name="width">The width of the polynomial in bits. Must be greater than 0 and less than 129. Default is 128.</param>
			public ReflectedUInt128(UInt128 polynomial, UInt128 init, bool refOut, UInt128 xorOut, int width = 128) : this(polynomial, GenerateTableReflected(polynomial, width), init, refOut, xorOut, width)
			{
			}
			...
			public UInt128 Value
			{
				get { return (reflectOutput ? register : BitOrder.Reflect(register, width)) ^ xorOutput; }
			}
