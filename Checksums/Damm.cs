...
namespace Xevle.Data.Checksums
{
	/// <summary>
	...
	public static class Damm
	{
		...
		/// </summary>
		public static readonly int[,] TAQ10a = { { 0, 3, 1, 7, 5, 9, 8, 6, 4, 2 }, { 7, 0, 9, 2, 1, 5, 4, 8, 6, 3 }, { 4, 2, 0, 6, 8, 7, 1, 3, 5, 9 }, { 1, 7, 5, 0, 9, 8, 3, 4, 2, 6 }, { 6, 1, 2, 3, 0, 4, 5, 9, 7, 8 }, { 3, 6, 7, 4, 2, 0, 9, 5, 8, 1 }, { 5, 8, 6, 9, 7, 2, 0, 1, 3, 4 }, { 8, 9, 4, 5, 3, 6, 2, 0, 1, 7 }, { 9, 4, 3, 8, 6, 1, 7, 2, 0, 5 }, { 2, 5, 8, 1, 4, 3, 6, 7, 9, 0 } };

		/// <summary>
		/// Another (weak) totally anti-symmetric quasigroup.
		/// </summary>
		public static readonly int[,] TAQ10b = { { 0, 2, 3, 4, 5, 6, 7, 8, 9, 1 }, { 2, 0, 4, 1, 7, 9, 5, 3, 8, 6 }, { 3, 7, 0, 5, 2, 8, 1, 6, 4, 9 }, { 4, 1, 8, 0, 6, 3, 9, 2, 7, 5 }, { 5, 6, 2, 9, 0, 7, 4, 1, 3, 8 }, { 6, 9, 7, 3, 1, 0, 8, 5, 2, 4 }, { 7, 5, 1, 8, 4, 2, 0, 9, 6, 3 }, { 8, 4, 6, 2, 9, 5, 3, 0, 1, 7 }, { 9, 8, 5, 7, 3, 1, 6, 4, 0, 2 }, { 1, 3, 9, 6, 8, 4, 2, 7, 5, 0 } };
		#endregion
